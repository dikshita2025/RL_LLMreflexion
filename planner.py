...
class Base_Planner(ABC):
    ...
    def __init__(self, offline=True, soft=False, prefix=''):
        ...
        self._INVALIDATION_THRESHOLD: int   = 15        # raised: tolerate more before invalidating
        self._CONFIDENCE_DECAY:       float = 0.15  # each failure decays confidence
    ...
    def _infer_task_implications(self, obs_text: str) -> str:
        ...
        if "door" in txt and "holds <key>" in txt:
